...
class Good:
    def __init__(self, name, price, stock, info):
        self.name = name
        self.price = price
        self.stock = stock
        self.info = info
...
user_links_ali=['https://www.aliexpress.com/item/1005006093798282.html'] 
...
for url in user_links_ozon:
    ...
    if age_confirmation:
        ...
        stock = False
        info = '-'
        good = Good(name, price, stock, info)
...
'''driver.execute_script("window.open('https://www.wildberries.ru/', '_blank');")
driver.execute_script("window.open(''https://aliexpress.ru'', '_blank');")'''
